        ...
        children: [
          ...
          _TutorialStep(
            ...
            text:
                ...
                '例如“第 4 周周二”。之后'
                // iOS 本轮没有桌面小组件，文案里就不提它
                '${defaultTargetPlatform == TargetPlatform.android ? '课表、小组件和提醒' : '课表和提醒'}'
                '会一起切换。',
          ),
          const _TutorialStep(
            number: '5',
          ...
          // 第 7、8 步是 Android 专有的，iOS 上不展示：
          //  - 第 7 步走的是 Android「长按桌面」添加小组件的流程；
          //  - 第 8 步讲的是国产 Android 的自启动 / 电池优化限制。
          // iOS 的通知由系统统一调度，不存在被后台杀进程的问题，
          // 没有这两类设置可做。
